...
ASCII кодови са декадним вредностима од 32 до 126 су "штампајући". Унеси и изврши следећи програм како би исписао штампајуће ASCII карактере на стандардни излаз у табели 10х10.
